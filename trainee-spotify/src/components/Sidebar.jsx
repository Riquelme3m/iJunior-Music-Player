    ...
    return (
        <aside className="w-[30%] bg-[#000000] text-white flex flex-col overflow-hidden max-w-[263px] ">
            ...
            <div className="sticky top-0 pl-2 bg-black h-[100vh] flex flex-col gap-[1rem] items-[center] sm:items-center">
                ...
                <button onClick={() => navigate('/')} className="cursor-pointer flex gap-[0.1rem] items-center w-[100%] justify-start sm:justify-center">
                ...
                <button onClick={() => navigate('/likes')} className="cursor-pointer flex gap-[0.4rem] items-center w-[100%] justify-start sm:justify-center">
